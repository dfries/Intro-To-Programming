...
# Read and store the temperature from the Sense HAT with sense.get_termperature()
# TODO Add a variable and store reading

# Read and store the humidity from the Sense HAT with sense.get_humidity()
# TODO Add a variable and store reading


# Verify values read in by printing out variables
# TODO print out both variables
