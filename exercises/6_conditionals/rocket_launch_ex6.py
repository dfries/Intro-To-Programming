...
# TODO Add an if/else statment here that checks temperature
'''
Example:
if (temp >= minmum and temp <= maximum)
    set temp_good to True
else
...
# TODO Add an if/else statment here that checks humidity that is similar to temp
...
# TODO Add env_good boolean variable set by combining temp and humidity with 'and'
