'''
This file provides an example of the fourth step of a rocket launch program
...
In this file we:
 - Countdown from 9 to 0 before the launch
 - Display the countdown to the Sense HAT
'''
...
# TODO add a for loop here that counts down from 9 
...
for i in range(??, ??, -1)
    ...
    if i == 0:
         Set countdown_complete to True
    else:
        sleep 1 second
'''
